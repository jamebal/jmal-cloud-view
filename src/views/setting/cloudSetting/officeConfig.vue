  ...
  <div class="container">
    <el-form ref="officeConfigForm" :model="configFormData" label-width="150px" size="small"
      ...
      <el-form-item label="OnlyOffice地址" prop="documentServer">
        ...
        <span class="form-instruction">OnlyOffice Server 地址</span>
      </el-form-item>
      ...
      <el-form-item label="回调服务地址" prop="callbackServer">
        <el-input placeholder="JmalCloud Server 地址" v-model.number="configFormData.callbackServer"></el-input>
        <span class="form-instruction">JmalCloud Server 地址</span>
      </el-form-item>
      <el-form-item>
