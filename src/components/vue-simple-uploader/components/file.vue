...
<script>
  import Uploader from '@/utils/simple-uploader/uploader'
  ...
  export default {
    ...
    watch: {
      ...
      'file._prevProgress': function() {
        this.fileEventsHandler('fileProgress', [this.file, null]);
      },
      'file._fileComplete': function() {
        this.fileEventsHandler('fileComplete', [this.file, null]);
      },
    },
    methods: {
      _actionCheck () {
        ...
        this.isUploading = typeof this.file.isUploading === 'function'
      ...
      _fileProgress () {
        ...
        this.timeRemaining = typeof this.file.timeRemaining === 'function'
          ? this.file.timeRemaining()
          : (this.file.timeRemaining || 0)
        this.uploadedSize = typeof this.file.sizeUploaded === 'function'
          ? this.file.sizeUploaded()
          : (this.file.uploadedSize || 0)
        this._actionCheck()
      },
